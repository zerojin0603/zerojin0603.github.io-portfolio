module.exports = {
  siteMetadata: {
    ...
    description: `끊임없이 도전하며 성장하는 엔지니어입니다.`,
    ...
    projects: [
      {
        ...
        description:
          '디스코드, 텔레그램, 트위터(이하 히든채널)에서 발생하는 다양한 유형의 사이버 범죄를 모니터링하여 최종적으로 사이버 범죄 예방에 기여하는 것을 목표로 하는 프로젝트를 진행하였습니다. \n 히든채널의 대화들을 크롤링하여 전처리 작업을 거친 텍스트 데이터를 기반으로 자연어처리 모델을 학습시켜 범죄와의 연관도를 계산 전처리 작업과 모델의 fine-tuning을 담당하였습니다. ',
      },
      {
     ...
     //   link: 'https://github.com/RyanFitzgerald/devfolio',
      },  
      {
        ...
        description:
          ...
          라즈베리 파이를 이용해 비밀번호를 저장하고 저장된 비밀번호를 출력하는 IoT 디바이스 간 암호화 통신 프로그램 'PassKeeper' 구현하였습니다.`,
     //   link: 'https://github.com/RyanFitzgerald/devfolio',
      },        
    ],
    ...
    experience: [
      {
        name: 'Nexon Korea',
        description: 'Security Engineer, October 2021 - ',
        link: 'https://github.com/RyanFitzgerald/devfolio',
      },
      {
    ...
    skills: [
      ...
      },
      {
        name: 'Other',
        description:
          'Docker, Amazon Web Services (AWS), ELK',
      },
    ]
  },
  plugins: [
